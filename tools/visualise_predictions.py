...
from tools.visual import draw_scenes_video, draw_scenes
import re
import math
...
def main():
    ...
    #     print(f"Batch {i}, data {data_batch}")
    ...
    for i, data_batch in enumerate(data_loader):
        ...
        # print(f"\n Outputs{outputs}")
        # print(f"Length of data_batch: {data_batch['points']}")
        # for j in range(0, len(data_batch['points'])):
        seq_name = re.search("seq_[0-9]*", data_batch['metadata'][0]['token']).group()
        reset_window = False
    ...
    if result_dict is not None:
        ...
        print("No evaluation: result dict is None")
